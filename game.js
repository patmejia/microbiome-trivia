...
let questions = [
    ...
    {   
        "question": "While microbiota is the microbial taxa associated with humans, the microbiome is the catalog of microbes and their harbored genes.",       // question 2
        "choice1": "False",
        "choice2": "True",
        "answer": 2
    },
...
//         // questions = loadedQuestions.results amp loadedQuestions.results.forEach(question => {
//         questions = loadedQuestions.results.results.map(loadedQuestion => {
//             const formattedQuestion = {
//                 question: loadedQuestion.question,
//             };
//             const answerChoices = [...loadedQuestion.incorrect_answers];
//             formattedQuestion.answer = Math.floor(Math.random() * 4) + 1;   // random number between 1 and 4
